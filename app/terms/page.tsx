  ...
  return (
    <div className="min-h-screen bg-ivory pt-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <h1 className="font-display text-ink text-4xl font-bold mb-2">Terms & Policies</h1>
        <p className="text-ink-muted text-sm mb-8">Last updated: 1 Jan 2026</p>

        {/* Tab selector */}
        <div className="flex gap-2 mb-8 overflow-x-auto scrollbar-hide">
          {['Terms & Conditions', 'Privacy Policy', 'Cancellation Policy'].map(tab => (
            <button key={tab} className="flex-none px-4 py-2 text-sm font-semibold rounded-full border border-forest/20 text-ink-muted hover:border-forest hover:text-forest transition-colors first:bg-forest first:text-white first:border-forest">
              {tab}
            </button>
          ))}
        </div>
        ...
        <div className="bg-white rounded-2xl border border-black/5 p-8 space-y-8">
          {[
            ...
            },
            {
              ...
              content: 'Free cancellation is available up to 12 hours before scheduled pickup time. Cancellations made between 6–12 hours before pickup attract a 10% charge. Cancellations within 6 hours of pickup attract a 25% charge. No-shows are charged 50% of the total fare.',
            },
            {
              title: '4. Vehicle & driver',
